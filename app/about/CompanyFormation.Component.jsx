...
const CompanyFormation = () => {
  return (
    <section
      className={`pt-16 pb-12 sm:pb-9 md:pb-6 lg:pb-3 xl:pb-2 2xl:pb:1 overflow-scroll md:overflow-clip px-12 md:px-0 md:mt-0 h-[45vh] sm:h-[40vh] xl:h-[40vh] 2xl:h-[35vh]  grid grid-cols-1 grid-rows-[min-content_min-content] md:gap-6`}
    >
      <motion.div
