...
const CompanyFormation = () => {
  return (
    <section
      className={`px-12 md:px-0 pt-36 md:mt-0 h-[50vh] md:h-[75vh] grid grid-cols-1 grid-rows-[min-content_min-content_min-content] md:grid-rows-3 gap-y-9 md:gap-y-0`}
    >
      <motion.div
