...
const Section = (props) => {
  ...
  return (
    <section className="md:mt-16 h-[60vh] md:h-[60vh] rounded-none w-full overflow-scroll md:overflow-hidden m-0 md:w-[80vw] md:m-auto grid grid-cols-[1fr] md:grid-cols-[1fr_1fr] grid-rows-[1fr_1fr] md:grid-rows-1 gap-y-24 md:gap-y-0 gap-x-16">
      <motion.div
