...
const Section = (props) => {
  ...
  return (
    <section className="mt-16 mb-16 overflow-x-hidden lg:overflow-clip h-[70vh] md:h-[60vh] lg:h-[377px] rounded-none w-full overflow-scroll md:overflow-visible m-0 md:w-[80vw] md:m-auto grid grid-cols-[1fr] md:grid-cols-[1fr_1fr] grid-rows-[1fr_1fr] md:grid-rows-[377px] gap-y-24 md:gap-y-0 gap-x-12">
      <motion.div
