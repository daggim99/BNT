    ...
    <section className={`w-screen grid`}>
      {locations.map((location) => {
        return (
          <div
            key={location.id}
            className={`justify-self-center self-center w-[80vw] mx-auto grid grid-cols-[1fr_1fr] grid-rows-1`}
          >
            <div
              className={`w-[514px] col-start-1 col-span-1 gird grid-cols-[min-content_min_content] grid-rows-3`}
            >
              <div
                className={`col-start-1 col-span-1 row-start-1 row-span-full justify-self-center self-center`}
              >
                <svg
                  width="96"
                  height="144"
              ...
              <div
                className={`col-start-2 col-span-1 row-start-1 row-span-1 justify-self-center self-center`}
              >
                <h1
                  className={`w-[228px] text-[40px] text-left text-black font-roboto-n700 font-bold capitalize`}
                >
                  {location.name}
                </h1>
              </div>
              <div
                className={`col-start-2 col-span-1 row-start-2 row-span-1 justify-self-center self-center`}
              >
                <p
                  className={`w-[348px] text-[24px] text-black text-left font-roboto-n700`}
                >
                  {location.description}
                </p>
              </div>
              <div
                className={`col-start-2 col-span-1 row-start-3 row-span-1 justify-self-center self-center grid grid-cols-[min-content_min-content] grid-rows-2`}
              >
                <div
                  className={`col-start-1 col-span-1 row-start-1 row-span-full self-start justify-self-center`}
                >
                  <svg
                    width="45"
                    height="48"
                ...
                <div
                  className={`col-start-2 col-span-1 row-start-1 row-span-1 justify-self-start self-center`}
                >
                  <p
                    className={`text-left text-[32px] text-black font-roboto-n700 font-bold`}
                  >
                    {location.phone1}
                  </p>
                </div>
                <div
                  className={`col-start-2 col-span-1 row-start-2 row-span-1 justify-self-start self-center`}
                >
                  <p
                    className={`text-left text-[32px] text-black font-roboto-n700 font-bold`}
                  >
            ...
            <div
              className={`col-start-2 col-span-1 justify-self-center self-center`}
            >
              <iframe
                key={location.id}
                loading="lazy"
