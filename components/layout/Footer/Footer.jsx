...
const Footer = () => {
  return (
    <footer className="h-[65vh] sm:h-[50vh] md:h-[35vh] bg-[#4A171E] grid grid-cols-1 md:grid-cols-2 grid-rows-4 md:grid-rows-[1fr_1fr_1fr] gap-y-3">
      ...
      <p className="text-white text-center text-[12px] sm:text-[14px] md:text-[18px] lg:text-[20px] xl:text-[21px]  font-roboto font-bold col-start-1 col-end-3 justify-self-center p-9 self-end">
