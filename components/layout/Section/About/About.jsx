...
const About = () => (
  <Section
    ...
    className={{
      card: 'max-h-[100vh] min-h-[50vh] overflow-scroll md:overflow-clip sm:max-h-[85vh] sm:min-h-[55vh] pt-9 sm:pt-12 md:pt-0 md:h-[55vh] row-start-2 row-end-3 py-6 sm:py-3 md:py-0 dark:bg-white',
      cardTitle:
