...
const About = () => (
  <Section
    ...
    className={{
      card: 'h-[70vh] sm:h-[60vh] md:h-[55vh] lg:h-[55vh] xl:h-[40vh] 2xl:h-[30vh] 2xl:pt-12 overflow-scroll md:overflow-clip sm:max-h-[85vh] sm:min-h-[55vh] pt-9 sm:pt-12 md:pt-0 md:h-[55vh] row-start-2 row-end-3 py-6 sm:py-3 md:py-0 dark:bg-white',
      cardTitle:
