...
const Business = () => (
  <Section
    ...
    className={{
      card: 'pt-20 md:pt-0 h-[70vh] sm:h-[65vh] md:h-[60vh] lg:h-[60vh] xl:h-[40vh] 2xl:h-[35vh] 2xl:pt-12 overflow-scroll md:overflow-clip sm:max-h-[85vh] sm:min-h-[55vh] bg-[#FFC10747] row-start-6 lg:row-start-5 text-black',
      cardTitle:
