...
const OurProducts = () => (
  <Section
    ...
    className={{
      card: 'lg:pt-12 max-h-[100vh] min-h-[50vh] overflow-scroll md:overflow-clip sm:max-h-[65vh] sm:min-h-[60vh] pt-9 md:pt-0 md:h-[45vh] lg:h-[50vh] row-start-2 row-end-3 py-9 dark:bg-white',
      cardTitle:
